...
const SignUp = () => {
    ...
    const signUp = ()=> {
        ...
        setLoading(true);
        const data = {username:signUpData.username,email:signUpData.email,password:signUpData.password};
        axios({
            method: "POST",
                    ...
                    <Grid container style={{marginBottom:"2rem"}}>
                        <Grid item xs={12}>
                            <Slide direction="down" in mountOnEnter unmountOnExit>
                                <div>
                                    <Typography variant='h4' style={{fontWeight:"bold",textAlign:"center",fontSize:"1.7rem",marginBottom:"0.2rem"}}>Welcome To <span style={{color: '#6c63ff',fontSize:"2rem"}}>Online Voting System.</span></Typography>
