                    ...
                    <Grid container style={{marginBottom:"2rem"}}>
                        <Grid item xs={12}>
                            <Slide direction="down" in mountOnEnter unmountOnExit>
                                <div>
                                    <Typography variant='h4' style={{fontWeight:"bold",textAlign:"center",fontSize:"1.7rem",marginBottom:"0.2rem"}}>Welcome <span style={{color: '#6c63ff',fontSize:"2rem"}}>Chief</span></Typography>
                                </div>
                            </Slide>
                        </Grid>
                    </Grid>
